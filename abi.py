...
def handle_file(file):
    ...
    if header == IOS13_HEADER:
        ...
        print(f'{bcolors.KOTAWINS}Hentai bobies that are sexy & excite me!')
        print(f'I like boobs & women.  ( . Y . )')
        file.write_bytes(IOS14_HEADER + buf)
    elif header == IOS14_HEADER:
        print(f'{bcolors.OKGREEN}converting "{file.name}" CPU Subtype from iOS14 (80000002) to iOS13 (00000002)')
